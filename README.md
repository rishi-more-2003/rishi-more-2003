...
**conformal thinking: risk control for reasoning on a compute budget**  
accepted at icml 2026 · [arxiv](https://arxiv.org/abs/2602.03814)

**privacy-preserving video analytics through gan-based face de-identification**  
nmitcon 2024 · [paper](https://doi.org/10.1109/NMITCON62075.2024.10698920)

**toxic comment detection using bidirectional sequence classifiers**  
idciot 2024 · [paper](https://doi.org/10.1109/IDCIoT59759.2024.10467922)

**harnessing insights from streams: unlocking real-time data flow with docker and cassandra in the apache ecosystem**  
raics 2024 · [paper](https://doi.org/10.1109/RAICS61201.2024.10690115)

**prism: predictive resource inference and spot instance management**  
iconat 2024 · [paper](https://doi.org/10.1109/ICONAT61936.2024.10774810)

**a streamlined approach towards monkeypox detection**  
preprint · [paper](https://www.techrxiv.org/articles/preprint/A_Streamlined_Approach_towards_Monkeypox_Detection/24634083)
...
preprint · [paper](https://www.techrxiv.org/articles/preprint/Preserving_Privacy_in_Video_Analytics_A_Comprehensive_Review_of_Face_De-Identification_and_Background_Blurring_Techniques/24587100)

**a lightweight approach towards speaker authentication systems**  
preprint / work in progress · [paper](https://www.techrxiv.org/users/707325/articles/694309-a-lightweight-approach-towards-speaker-authentication-systems)
